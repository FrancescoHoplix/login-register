...
if (isset($_POST['registrazione'])) {
    ...
    // Esegui la funzione processRegistration
    $utente->processRegistration();
}
?>
...
<div class="container mt-5">
    <div class="body d-md-flex align-items-center justify-content-between h-100">
        <div class="container text-warning">
            <form action="register.php" method="POST" class="login-form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="codice_fiscale" class="form-control text-uppercase" minlength="16" maxlength="16" required>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="provincia" class="form-control text-uppercase" maxlength="2" required>
                    </div>
                </div>

                <button type="submit" class="btn btn-primary" name="registrazione">Invio</button>
            </form>
        </div>
